 ...
 * This is a dependency for the InitialEnquiryController class.
 */
module.exports.name = 'InitialEnquiryRepository'
module.exports.dependencies = ['InitialEnquiryModel', 'logger']
