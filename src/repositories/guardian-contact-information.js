 ...
 * This is a dependency for the GuardianContactInformationController class.
 */
module.exports.name = 'GuardianContactInformationRepository'
module.exports.dependencies = ['GuardianContactInformationModel', 'logger']
