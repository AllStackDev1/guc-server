 ...
 * This is a dependency for the EmergencyContactController class.
 */
module.exports.name = 'EmergencyContactRepository'
module.exports.dependencies = ['EmergencyContactModel', 'logger']
