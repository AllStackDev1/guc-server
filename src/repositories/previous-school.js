 ...
 * This is a dependency for the PreviousSchoolController class.
 */
module.exports.name = 'PreviousSchoolRepository'
module.exports.dependencies = ['PreviousSchoolModel', 'logger']
